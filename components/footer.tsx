export function Footer() {
  return (
    <footer className="bg-gradient-to-b from-white to-orange-50 border-t border-orange-200">
      {/* About Section */}
      <div className="max-w-[1200px] mx-auto px-4 md:px-12 py-16">
        <div className="text-center max-w-2xl mx-auto">
          <h3 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl tracking-wider mb-6 text-black">
            Why <span className="text-orange-500">Turbo Bites</span>?
          </h3>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            <div className="flex items-center gap-2 text-gray-700 bg-white border border-orange-200 rounded-full px-4 py-2 shadow-sm">
      ...
      <div className="bg-black py-8">
        <div className="max-w-[1200px] mx-auto px-4 md:px-12 text-center">
          ...
          <div className="text-gray-400 text-sm mb-4">
            ...
            <a href="https://wa.me/923101777790" className="text-orange-500 hover:underline">
              0310-1777790
            </a>
          </div>
      ...
      <div className="bg-black border-t border-white/10 py-6">
        <div className="max-w-[1200px] mx-auto px-4 md:px-12 text-center">
          <p className="text-gray-400 text-sm mb-2">
            <span className="text-orange-500 font-semibold">TURBO BITES</span> — Attock&apos;s Finest Fast Food
          </p>
