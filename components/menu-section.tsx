...
export function MenuSection({ category }: MenuSectionProps) {
  ...
  return (
    <section className="max-w-[1200px] mx-auto py-16 px-4 md:px-12 bg-white" id={category.id}>
      {/* Section Header */}
      <div className="flex items-baseline gap-4 mb-10">
        <h2 className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl tracking-wider text-black">
...
export function Divider() {
  return (
    <div className="h-px bg-gradient-to-r from-transparent via-orange-300 to-transparent mx-4 md:mx-12" />
  )
}
